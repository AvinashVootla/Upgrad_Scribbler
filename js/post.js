...
function changeText() {
	if (flag == 0) {
		var a = document.getElementById("postBody").innerHTML;
		...
		var title = document.getElementById("postTitleNew").innerHTML;
		document.getElementById("titleArea").value = title;
		document.getElementById("postTitleNew").style.display = "none";
		document.getElementById("titleArea").style.display = "block";
		flag = 1;
	} else {
		var c = document.getElementById("textarea").value;
		document.getElementById("postBody").innerHTML = c;
		document.getElementById("postBody").style.display = "block";
		document.getElementById("textarea").style.display = "none";
		var d = document.getElementById("titleArea").value;
		document.getElementById("postTitleNew").innerHTML = d;
		document.getElementById("postTitleNew").style.display = "block";
